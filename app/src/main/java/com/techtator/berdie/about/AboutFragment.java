...
public class AboutFragment extends Fragment implements AboutContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView = (WebView)view.findViewById(R.id.about_webview);

        mImageView = (ImageView)view.findViewById(R.id.about_imageview);
        return view;
    }
    ...
    @Override
    public void setLogoAndBody(String logo, String body) {
        Picasso.get()
                .load(logo)
